<?php 
    ...
    $linkSplit = explode('/', $url);
    $link_gotten= ($linkSplit[1]);


    $query1="SELECT link FROM admin_link WHERE link = '$link_gotten'";
            ...
            $result1 = mysqli_query($con,$query1) or die(mysqli_error());
                    ...
                    //$query2 = "INSERT into `admin_link` (link) VALUES ('$link_gotten')";
                        $query2 = "INSERT into `invitees_tbl` (link,oauth,valid) VALUES ('$link_gotten','$encoded',1)";
                        // var_dump($query2);
